...
public class IntegracaoRestRocketChatEnviarMensagemTest {
    ...
    public void setUp() {
        ...
        RespostaWebServiceSimples resposta = FabApiRestRocketChatV1Channel.QUEM_SOU_EU.getAcao().getResposta();
    ...
    public void testSomeMethod() {
        ...
        RespostaWebServiceSimples resposta = FabApiRestRocketChatV1Direct.OBTER_CODIGO_SALA_DIRECT_DO_USUARIO.getAcao("salvio").getResposta();
